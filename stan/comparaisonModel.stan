...
model {
    LDR1 ~ normal(LDR_mu[1], LDR_sigma[1]);
    LDR2 ~ normal(LDR_mu[2], LDR_sigma[2]);

    HDR1 ~ normal(HDR_mu[1], HDR_sigma[1]) T[HDR_alpha[1], ];
    HDR2 ~ normal(HDR_mu[2], HDR_sigma[2]) T[HDR_alpha[2], ];
